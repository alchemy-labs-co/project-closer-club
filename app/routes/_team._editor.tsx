...
function TeamLeaderCourseSidebar() {
	return (
		<aside className="w-full flex-1 md:max-w-64 h-[calc(100vh-76.8px)] overflow-hidden bg-gray-50 md:border-r border-r-0 border-b md:border-b-0 border-gray-200 p-2 flex flex-col justify-between gap-4 sticky top-0">
			<div className="h-full w-full flex flex-col gap-4 overflow-hidden bg-white rounded-lg border p-3">
