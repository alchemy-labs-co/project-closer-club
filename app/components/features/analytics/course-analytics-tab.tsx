...
export default function CourseAnalyticsTab({
	...
	const strokeDashoffset =
		circumference - (course.progressPercentage / 100) * circumference;

	// Quiz analytics calculations
	const quizStrokeDashoffset =
		circumference - (course.quizCompletionPercentage / 100) * circumference;
		...
		<div className="space-y-6 p-4">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Detailed quiz statistics and accuracy
					</CardDescription>
				</CardHeader>
