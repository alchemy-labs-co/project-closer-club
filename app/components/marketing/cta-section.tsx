...
export function CTASection() {
	return (
		<section id="join-team" className="relative overflow-hidden">
			...
			<div className="relative z-30 mx-auto w-full max-w-7xl px-6 lg:px-12 py-12">
					...
					<div className="flex flex-col gap-8 pb-16">
						<div className="flex flex-col gap-6 text-center">
							...
							<p className="text-lg text-white/80 mx-auto max-w-2xl">
								Join thousands of insurance professionals who have accelerated
								their success with Closer Club. Get started with our
								comprehensive training platform today.
							</p>
						</div>
